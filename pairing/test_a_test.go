...
func TestMakeTypeAPairing(t *testing.T) {
	...
	elemTest1 := typeAPairing.Zq.NewElement(&biTest1)
	...
	elemTest2 := typeAPairing.Zq.NewElement(&biTest2)
	...
	Z := typeAPairing.TheMapping.Pairing(typeAPairing.G1.GetGen(), typeAPairing.G1.GetGen())
	testPoint(t, Z,
	...
	// e(g^a, g^b)
	testPowPairing := typeAPairing.TheMapping.Pairing(powTest1, powTest2)
